...
export default function NewsPage() {
  return (
    <>
      <PageHero title="News & Updates" subtitle="Stay informed about our latest activities, events, and achievements." breadcrumbs={[{ label: "News & Updates", href: "/news-updates" }]} />
